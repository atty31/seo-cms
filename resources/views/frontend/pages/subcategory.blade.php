    ...
    <div class="main-content">
        ...
        <div class="main-posts-3">
            <div class="mp-section">
                {!! html_entity_decode($subcategory_content) !!}
            </div>
        </div>
        <!-- Main posts END -->
        <div class="section">
                                        ...
                                        @if ($subcat->is_active == 1)
                                            <div class="col-half">
                                                <article class="post post-tp-8">
                                                    <figure>
                                                        <a href="{{$subcat->curl_name}}/{{$subcat->purl_name}}">
                                                            @if (!empty($subcat->path))
                                                                <img src="{{ asset($subcat->path) }}" height="242" width="345" @if( !empty($subcat->alt_image)) alt="{{$subcat->alt_image}}" @endif class="adaptive" />
                                                            @else
                                                    ...
                                                    <h3 class="title-5"><a href="{{$subcat->curl_name}}/{{$subcat->purl_name}}">{{$subcat->ptitle}}</a></h3>
                                                    <div class="meta-tp-2">
                                                        <div class="date"><span>{{ date('F d, Y', strtotime($subcat->created_at)) }}</span></div>
                                                        {{--<div class="category">--}}
                                                            {{--<a href=""><i class="li_pen"></i><span>{{$subcat->uname}}</span></a>--}}
                                                        {{--</div>--}}
                                                    </div>
                                                </article>
                                            </div>
